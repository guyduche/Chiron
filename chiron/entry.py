...
def main(arguments=sys.argv[1:]):
    ...
    parser_call.add_argument('-x','--normalize',type=bool,default=True,help="Signal normalization. Default: True")
    ...
    parser_train.add_argument('-x','--normalize',type=bool,default=True,help="Signal normalization. Default: True")
